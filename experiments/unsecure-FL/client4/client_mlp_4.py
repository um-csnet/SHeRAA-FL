...
x_train = np.load("x_train-client4.npy")
y_train = np.load("y_train-client4.npy")

x_test = np.load("x_test-client4.npy")
y_test = np.load("y_test-client4.npy")
...
fl.client.start_numpy_client(server_address="127.0.0.1:8080", client=ntcClient(client_id="client_4"))