...
MAX_ROUNDS = 3
model_name = "clf1_global_model_trim_fedavg_mlp_6client_36epochs_3round_cpu.h5"
...
strategy = SaveKerasModelStrategy(min_available_clients=6, min_fit_clients=6, min_evaluate_clients=6, beta=0.1)
